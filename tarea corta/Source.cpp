...
int main(int argc, char ** argv)
{
	...
	Circle c(Point(200, 200), 50); c.set_fill_color(Color::red);
	Simple_window sw(Point(10,10), colmax * width, colmax * width - 300, ""); sw.attach(c);
	//colmax * width + 20, rowmax * height + 240
